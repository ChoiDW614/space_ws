...
class CuriosityWrapper(RobotWrapper):
    def __init__(self):
        package_name = "mppi_controller"
        urdf_file_path = os.path.join(get_package_share_directory(package_name), "models", "curiosity", "curiosity_mars_rover.urdf")
        ...
        self.__ee_joint_name = "arm_tools_joint"
